...
def confirm_update(root):
    response = messagebox.askyesno("Confirmar update/download",
...
def download_model(auth_token, modeluri):
    ...
    print(modeluri)
    try:
        snapshot_download(repo_id=modeluri,
                          use_auth_token=auth_token,
                          local_dir=r'../docchat-llm/src/models')
