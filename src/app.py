...
if len(listdir(r"../src/models")) > 1:
    modelPath = r"../src/models"
    pipe = pipeline(
        "text-generation",
        model=modelPath,
        device_map='auto'
...
chat_window.grid(row=0,
                 ...
                 pady=10,
                 sticky="nsew")
chat_window.tag_config("blue_text",
                       foreground="blue")

user_entry = tk.Text(root,
                     height=3)
...
menu_bar.add_cascade(menu=model_menu,
                     label="Modelo")
